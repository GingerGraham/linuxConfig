...
input=$1
dir=~/dotFiles
olddir=~/Test/oldDotFiles # Default value, replace with $input if valid
# TODO replace hard coded list with list of dot files in directory
# files=".bashrc .bash_aliases .vimrc .zshrc .gitconfig .tmux.conf .zprofile"
